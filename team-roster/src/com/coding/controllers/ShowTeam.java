	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("id") == null) {
			...
			if(session.getAttribute("listOfTeams") != null) {
				ArrayList<Team> arrList = (ArrayList<Team>) session.getAttribute("listOfTeams");
				request.setAttribute("team", arrList.get(Integer.parseInt(request.getParameter("id"))));
				session.setAttribute("team", arrList.get(Integer.parseInt(request.getParameter("id"))));
				session.setAttribute("index", request.getParameter("id"));
				RequestDispatcher req = request.getRequestDispatcher("/WEB-INF/teamDetails.jsp");
				req.forward(request, response);
			}
